...
TEST_UNIT "new_tree_test1" = assert_true(new_tree ((1.0,1.5),(2.0,2.3)) = Leaf (((1., 1.5), (2., 2.3)), []))
TEST_UNIT "new_tree_test2" = assert_true(new_tree ((0.0,0.0),(0.0,0.0)) = Leaf (((0., 0.), (0., 0.)), []))
...
let f (x:'a) ((c:coord),(y:'b)) = x+.1.0
let g (x:'a) ((c:coord),(y:'b)) = y+.x+.1.0
let t : 'a quadtree = Node (((0.0,0.0),(1.0,1.0)), Leaf (((0.5,0.5),(1.0,1.0)),[]), 
  Leaf (((0.5,0.5),(1.0,1.0)),[]), Leaf (((0.5,0.5),(1.0,1.0)),[]), Leaf (((0.5,0.5),(1.0,1.0)),[((0.25,0.25),3.)]))
let l : 'a quadtree = Leaf (((0.0,0.0),(1.0,1.0)),[])
let l1 : 'a quadtree = Leaf (((0.0,0.0),(1.0,1.0)),[((0.25,0.25),3.)])
let l2 : 'a quadtree = Leaf (((0.0,0.0),(1.0,1.0)),[((0.25,0.25),3.); ((0.76,0.76), 4.)])

TEST_UNIT "fold_quad_test1" = assert_true(fold_quad f 1.0 t = 2.)
TEST_UNIT "fold_quad_test2" = assert_true(fold_quad g 1.0 t = 5.)
TEST_UNIT "fold_quad_test3" = assert_true(fold_quad f 2.0 l = 2.)
TEST_UNIT "fold_quad_test4" = assert_true(fold_quad g 2.0 l1 = 6.)
TEST_UNIT "fold_quad_test5" = assert_true(fold_quad g 2.0 l2 = 11.)

TEST_UNIT "fold_region_test1" = assert_true(fold_region g 2.0 l1 ((0.0,0.0),(0.0,0.0)) =2.)
TEST_UNIT "fold_region_test2" = assert_true(fold_region g 1.0 t ((0.0,0.0),(2.0,1.0)) = 5.)
TEST_UNIT "fold_region_test3" = assert_true(fold_region f 1.0 l ((0.0,0.0),(2.0,1.0)) = 1.)
TEST_UNIT "fold_region_test4" = assert_true(fold_region g 2.0 l1 ((0.0,0.0),(2.0,1.0)) = 6.)
TEST_UNIT "fold_region_test5" = assert_true(fold_region g 2.0 l2 ((0.0,0.0),(2.0,1.0)) = 11.)
TEST_UNIT "fold_region_test6" = assert_true(fold_region g 2.0 l1 ((0.0,0.0),(0.1,0.1)) = 2.)
