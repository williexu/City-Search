...
TEST_UNIT "IntNat.( + )_test1" = assert_true ( (IntNat.( + )) (IntNat.nat_of_int(15)) (IntNat.nat_of_int(20)) = (IntNat.nat_of_int(35)))
...
TEST_UNIT "IntNat.( * )_test1" = assert_true ( (IntNat.( * )) (IntNat.nat_of_int(15)) (IntNat.nat_of_int(20)) = (IntNat.nat_of_int(300)))
TEST_UNIT "IntNat.( * )_test2" = assert_true ( (IntNat.( * )) (IntNat.nat_of_int(1)) (IntNat.nat_of_int(2)) = (IntNat.nat_of_int(2)))
TEST_UNIT "IntNat.( * )_test3" = assert_true ( (IntNat.( * )) (IntNat.zero) (IntNat.nat_of_int(2)) = (IntNat.zero))
TEST_UNIT "IntNat.( * )_test4" = assert_true ( IntNat.( * ) (IntNat.zero) (IntNat.one) = IntNat.zero)
TEST_UNIT "IntNat.( * )_test5" = assert_true ( IntNat.( * ) (IntNat.one) (IntNat.( * ) (IntNat.one) (IntNat.one)) = IntNat.one)
TEST_UNIT "IntNat.( * )_test6" = assert_true ( IntNat.( * ) (IntNat.one) (IntNat.( + ) (IntNat.one) (IntNat.one)) = IntNat.( + ) (IntNat.one) (IntNat.one))
TEST_UNIT "IntNat.( + )_test7" = assert_raises (Some (IntNat.Unrepresentable)) (IntNat.( * ) (IntNat.nat_of_int(max_int))) (IntNat.nat_of_int(max_int))
...
TEST_UNIT "ListNat.int_of_nat_test1" = assert_true (ListNat.int_of_nat(ListNat.nat_of_int(2)) = 2)
TEST_UNIT "ListNat.int_of_nat_test2" = assert_true (ListNat.int_of_nat(ListNat.nat_of_int(45)) = 45)
TEST_UNIT "ListNat.int_of_nat_test3" = assert_true (ListNat.int_of_nat(ListNat.zero) = 0)

(* test (nat_of_int) *)

TEST_UNIT "ListNat.nat_of_int_test1" = assert_true (ListNat.nat_of_int(2) = ListNat.( + ) ListNat.one ListNat.one)
TEST_UNIT "ListNat.nat_of_int_test2" = assert_true (ListNat.nat_of_int(0) = ListNat.zero)
TEST_UNIT "ListNat.nat_of_int_test3" = assert_raises (Some (ListNat.Unrepresentable)) ListNat.nat_of_int(-1)
...
TEST_UNIT "AlienNat.( + )_test1" = assert_true (AlienNat.( + ) (AlienNat.zero) (AlienNat.one) = AlienNat.nat_of_int(1))
TEST_UNIT "AlienNat.( + )_test2" = assert_true ( AlienNat.( + ) (AlienNat.nat_of_int(0)) (AlienNat.nat_of_int(2)) = AlienNat.nat_of_int(2))
TEST_UNIT "AlienNat.( + )_test3" = assert_true ( AlienNat.int_of_nat(AlienNat.( + ) (AlienNat.zero) (AlienNat.( + ) (AlienNat.one) (AlienNat.one))) = AlienNat.int_of_nat(AlienNat.nat_of_int(2)))
TEST_UNIT "AlienNat.( + )_test4" = assert_true ( AlienNat.( + ) (AlienNat.nat_of_int(6)) (AlienNat.nat_of_int(8)) = AlienNat.nat_of_int(14))

(* test ( * ) *)

TEST_UNIT "AlienNat.( * )_test1" = assert_true (AlienNat.( * ) (AlienNat.nat_of_int(1)) (AlienNat.nat_of_int(2)) = (AlienNat.nat_of_int(2)))
TEST_UNIT "AlienNat.( * )_test1" = assert_true (AlienNat.( * ) (AlienNat.nat_of_int(2)) (AlienNat.nat_of_int(1)) = (AlienNat.nat_of_int(2)))
TEST_UNIT "AlienNat.( * )_test2" = assert_true (AlienNat.( * ) (AlienNat.zero) (AlienNat.nat_of_int(2)) = (AlienNat.zero))
TEST_UNIT "AlienNat.( * )_test3" = assert_true (AlienNat.( * ) (AlienNat.one) (AlienNat.one) = AlienNat.one)
TEST_UNIT "AlienNat.( * )_test4" = assert_true (AlienNat.( * ) (AlienNat.one) (AlienNat.( * ) (AlienNat.one) (AlienNat.one)) = (AlienNat.one))
TEST_UNIT "AlienNat.( * )_test5" = assert_true (AlienNat.( * ) (AlienNat.one) (AlienNat.( + ) (AlienNat.one) (AlienNat.one)) = AlienNat.( + ) (AlienNat.one) (AlienNat.one))

(* test ( < ) *)

TEST_UNIT "AlienNat.( < )_test1" = assert_true ( (AlienNat.( < )) (AlienNat.nat_of_int(2)) (AlienNat.nat_of_int(4)))
TEST_UNIT "AlienNat.( < )_test2" = assert_false ( (AlienNat.( < )) (AlienNat.nat_of_int(3)) (AlienNat.nat_of_int(2)))
TEST_UNIT "AlienNat.( < )_test3" = assert_true ( (AlienNat.( < )) (AlienNat.zero) (AlienNat.one))
TEST_UNIT "AlienNat.( < )_test4" = assert_false ( (AlienNat.( < )) (AlienNat.one) (AlienNat.zero))

(* test (===) *)

TEST_UNIT "AlienNat.( === )_test1" = assert_true ( (AlienNat.( === )) (AlienNat.nat_of_int(2)) (AlienNat.nat_of_int(2)))
TEST_UNIT "AlienNat.( === )_test2" = assert_false ( (AlienNat.( === )) (AlienNat.nat_of_int(3)) (AlienNat.nat_of_int(2)))
TEST_UNIT "AlienNat.( === )_test3" = assert_true ( (AlienNat.( === )) (AlienNat.zero) (AlienNat.zero))
TEST_UNIT "AlienNat.( === )_test4" = assert_false ( (AlienNat.( === )) (AlienNat.one) (AlienNat.zero))

(* test (int_of_nat) *)

TEST_UNIT "AlienNat.int_of_nat_test1" = assert_true ((AlienNat.int_of_nat(AlienNat.nat_of_int(2))) = 2)
TEST_UNIT "AlienNat.int_of_nat_test2" = assert_true ((AlienNat.int_of_nat(AlienNat.nat_of_int(45))) = 45)
TEST_UNIT "AlienNat.int_of_nat_test3" = assert_true ((AlienNat.int_of_nat(AlienNat.zero)) = 0)
